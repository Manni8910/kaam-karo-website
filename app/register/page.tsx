  ...
  async function verifyAndRegister() {
    ...
    try {
      ...
      const data = await apiRequest("/api/otp/verify", {
        method: "POST",
        body: JSON.stringify({ phone, code: otp, name, userType }),
      });
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm p-8 w-full max-w-md">
        ...
        {step === "info" ? (
            ...
            <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                  userType === "seeker" ? "bg-white shadow text-[#FF4F5A]" : "text-gray-500"
                }`}
              >
                👷 Job Seeker
              </button>
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                  userType === "employer" ? "bg-white shadow text-[#FF4F5A]" : "text-gray-500"
                }`}
              >
                🏢 Employer
              </button>
            ...
            <div className="mb-6">
              ...
              <div className="flex">
                ...
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-r-xl focus:outline-none focus:border-[#FF4F5A]"
                />
              </div>
            </div>
          ...
          <>
            <p className="text-sm text-gray-500 mb-6">
              ...
              <button onClick={() => setStep("info")} className="text-[#FF4F5A] underline">Change</button>
            </p>
            {devCode && (
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/login" className="text-[#FF4F5A] font-medium">Login</Link>
        </p>
